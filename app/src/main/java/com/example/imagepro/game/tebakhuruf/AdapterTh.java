...
public class AdapterTh  extends RecyclerView.Adapter<AdapterTh.ViewHolder> {

    String data1[];
    Context context;

    public AdapterTh(Context ct, String s1[]){
        context = ct;
        data1 = s1;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.btn_levelTh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, TebakHuruf.class);
