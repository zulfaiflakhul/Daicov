...
public class  tebakGambarClass {
    ...
    // Tambahkan String classification_model, int classification_input_size


    tebakGambarClass (Button clear_button, Button add_button, TextView change_text, AssetManager assetManager, String modelPath, String labelPath, int inputSize, String classification_model, int classification_input_size) throws IOException{
